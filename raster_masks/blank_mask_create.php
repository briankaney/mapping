...
//--------------------------------------------------------------------------------------
  ...
  if($argc==1)
  {
    ...
    print "Examples:\n";
    print "   ./blank_mask_create.php ok.150x100.blank.gz 150 100 -95495 36495 10 10 1000\n";
    print "   ./blank_mask_create.php ok.751x501.blank.gz 751 501 -95500 36500 2 2 1000\n";
    print "   ./blank_mask_create.php conus.blank.gz 7000 3500 -129995 54995 10 10 1000\n\n";
